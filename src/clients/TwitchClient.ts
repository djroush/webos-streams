...
class TwitchClient implements TwitchInterface {
  ...
  public getUser(username: string, callback: () => void) {
  ...
  public getStream(userid: number, callback: () => void) {
  ...
  public getVideos(userid: number, callback: () => void) {
  ...
  public getClips(userid: number, callback: () => void) {
